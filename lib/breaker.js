...
const defaultFallback = exports.defaultFallback = (...args)=>{
  ...
  if(e instanceof Error){
    let underlying = Object.assign(e);
...
const attachBreaker = exports.attachBreaker = function(superMethod,methodName, defaultOptions={}){
  return (...args)=>{
    ...
    let options = Object.assign((params||{}).breakerOptions || defaultOptions); // defaults to options passed in during Service Class creation
...
const breakerWrapper = exports.breakerWrapper = ( 
  ...
  let SuperClass = buildSuperClass(ServiceClass);
